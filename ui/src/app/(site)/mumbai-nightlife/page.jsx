...
import NightlifeFaq from "./NightlifeFaq";

export const metadata = {
  title: "Mumbai Nightlife Guide — Mumbai96",
  description: "Ultimate Mumbai nightlife guide — rooftop bars, premium clubs, live music, late-night food, pub crawls, and safety tips for every neighbourhood.",
};

export default function MumbaiNightlifePage() {
  const areas = [
    {
      title: "Bandra West",
      tag: "Indie & Chill",
  ...
  return (
    <ScrollReveal>
      ...
      <nav className="bc bc--nightlife" aria-label="Breadcrumb">
        <Link href="/">Home</Link>
        <span> › </span>
        <Link href="/travel" className="bc-link-muted">
          Travel
        </Link>
        <span> › </span>
      ...
      <section className="venues-sec">
        <div className="con">
          ...
          <h2 className="st">
            Mumbai&apos;s Iconic <em>Nightlife Spots</em>
          </h2>
      ...
      <section className="tips-dark">
        <div className="con">
          <p className="sl">Stay Safe, Stay Smart</p>

          <h2 className="st">
            Mumbai Nightlife <em>Safety Tips</em>
          </h2>
